...
Write-Host "==> Running unit tests and collecting code coverage..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "==> Coverage report successfully generated at:" -ForegroundColor Green

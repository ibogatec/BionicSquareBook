...
namespace BionicSquare.DataAccess.Migrations
{
    ...
    [Migration("20260622185246_AddOrderDetailsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BionicSquare.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BionicSquare.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BionicSquare.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BionicSquare.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BionicSquare.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BionicSquare.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BionicSquare.Models.OrderDetails", b =>
                {
                    b.HasOne("BionicSquare.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BionicSquare.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BionicSquare.Models.OrderHeader", b =>
                {
                    b.HasOne("BionicSquare.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BionicSquare.Models.Product", b =>
                {
                    b.HasOne("BionicSquare.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BionicSquare.Models.ApplicationUser", null)
                        .WithMany()
